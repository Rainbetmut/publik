...
*GROUP 1*
https://chat.whatsapp.com/Kxgw8YE7JxuHjaKtGZAfvh`)
break
case 'getsxvdxcmd': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
           ...
           await XeonBotInc.sendMedia(m.chat, `https://xteam.xyz/${command}?file&text=${text}`, 'Rainbetmut', m, {asSticker: true})
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
teks = `Here you go!`
buffer = `https://api.lolhuman.xyz/api/randomimage/batues?apikey=Rainbetmutxyz`
...
case 'gsmarena': {
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            let res = await fetchJson(`https://lolhuman.xyz/webzone/gsmarena?query=${text}&apikey=Rainbetmutxyz`)
...
${themeemoji} Detail: ${detail}`
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            let res = await fetchJson(`https://lolhuman.xyz/webzone/jadwalbioskop?kota=${text}&apikey=Rainbetmutxyz`)
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            let res = await fetchJson(`https://lolhuman.xyz/webzone/amino?query=${text}&apikey=Rainbetmutxyz`)
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            let res = await fetchJson(`https://lolhuman.xyz/webzone/wattpad?query=$text}&apikey=Rainbetmutxyz`)
	...
	if (isBanChat) return reply(mess.banChat)
            if (!text) return reply(`Example : ${prefix + command} love`)
            let res = await fetchJson(`https://lolhuman.xyz/webzone/webtoons?query=${text}&apikey=Rainbetmutxyz`)
	...
	if (isBanChat) return reply(mess.banChat)
            if (!text) return reply(`Example : ${prefix + command} love`)
            let res = await fetchJson(`https://lolhuman.xyz/webzone/drakor?query=${text}&apikey=Rainbetmutxyz`)
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
xeony_buffer = await getBuffer(`https://github.com/Rainbetmut/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
